...
import dk.apaq.qash.app.data.ContainerFormattingWrapper;
import dk.apaq.qash.app.data.OrderLineContainer;
import dk.apaq.qash.app.data.util.CurrencyAmountFormatter;
import dk.apaq.qash.app.data.util.CurrencyAmountValidator;
import dk.apaq.qash.app.data.util.NumberFormatter;
import dk.apaq.qash.app.data.util.NumberValidator;
import dk.apaq.qash.app.data.util.PercentageFormatter;
import dk.apaq.qash.app.data.util.PercentageValidator;
import dk.apaq.qash.app.print.PrintDocGenerator;
import dk.apaq.qash.app.ui.common.CommonDialog;
import dk.apaq.qash.app.util.ItemFilterGenerator;
...
import dk.apaq.qash.share.model.OrderLineTax;
import dk.apaq.qash.share.model.OrderStatus;
import dk.apaq.qash.share.model.PaymentType;
import dk.apaq.qash.vaadin.SearchField;
...
public class OrderEditor extends CustomComponent implements
    ...
    private Crud.Filterable<String, dk.apaq.qash.share.model.Item> productCrud;
    ...
    private class EditorFieldFactory implements TableFieldFactory {
        ...
        public Field createField(Container container, Object itemId, Object propertyId, Component uiContext) {
            ...
            if (field instanceof TextField) {
                ...
                field.setStyleName(QashTheme.TEXTALIGN_RIGHT);
    ...
    public class OrderHeader extends CustomComponent {
        ...
        private final ItemFilterGenerator filterGenerator = new ItemFilterGenerator();
        ...
        public OrderHeader() {
            ...
            txt_barcode.setStyleName(QashTheme.TEXTFIELD_BARCODE);
    ...
    public OrderEditor() {
        ...
        header.getButtonAddLine().addListener(new ClickListener() {
            ...
            @Override
            public void buttonClick(ClickEvent event) {
                final NonStockItemCreatePanel createPanel = new NonStockItemCreatePanel(OrderEditor.this.taxContainer);
        ...
        header.getSearchField().addListener(new Property.ValueChangeListener() {
            ...
            public void valueChange(ValueChangeEvent event) {
                ...
                if (item instanceof HasBean) {
                    HasBean<dk.apaq.qash.share.model.Item> bi = (HasBean) item;
            ...
            public void valueChange(ValueChangeEvent event) {
                ...
                if (productCrud != null) {
                    ...
                    if (idlist.isEmpty()) {
                        ...
                        dk.apaq.qash.share.model.Item product = productCrud.read(idlist.get(0));
    ...
    public void setProductCrud(Filterable<String, dk.apaq.qash.share.model.Item> productCrud) {
        ...
        try {
            ...
            switch (printType) {
                case Invoice:
                    ...
                    break;
                default:
                    printDocGenerator.printReceipt(order, null, ps);

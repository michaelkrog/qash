...
import dk.apaq.qash.app.util.Country;
...
public class ShopForm extends Form {
    ...
    private class ShopFormFieldFactory extends DefaultFieldFactory {

        final ComboBox countries = new ComboBox("Country");

        public ShopFormFieldFactory() {
    ...
    public ShopForm() {
        ...
        setFormFieldFactory(new ShopFormFieldFactory());

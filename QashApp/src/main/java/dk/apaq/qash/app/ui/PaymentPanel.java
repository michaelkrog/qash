...
import dk.apaq.qash.app.ui.common.SwitchButtonGroup;
...
public class PaymentPanel extends CustomComponent implements Property, Property.Editor {
    ...
    public PaymentPanel() {
        ...
        textAmount.setStyleName(QashTheme.TEXTFIELD_XLARGE);
        textAmount.addStyleName(QashTheme.TEXTALIGN_RIGHT);

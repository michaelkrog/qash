...
public class SalesView extends CustomComponent {
    ...
    private Crud.Complete<String, dk.apaq.qash.share.model.Item> productCrud;
    ...
    public void setProductCrud(Crud.Complete<String, dk.apaq.qash.share.model.Item> productCrud) {
        this.productContainer = new CrudContainer(productCrud, dk.apaq.qash.share.model.Item.class);

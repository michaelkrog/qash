...
import dk.apaq.qash.app.data.ProductContainer;
import dk.apaq.qash.app.data.util.NumberColumnGenerator;
...
public class ProductList extends CustomComponent {
    ...
    private Crud<String, dk.apaq.qash.share.model.Item> productCrud;
    private Crud<String, dk.apaq.qash.share.model.Tax> taxCrud;
    ...
    public void setTaxCrud(Crud<String, dk.apaq.qash.share.model.Tax> taxCrud) {
        this.taxCrud = taxCrud;
        refreshTaxContainer();
    }

    public void setProductCrud(Crud<String, dk.apaq.qash.share.model.Item> productCrud) {

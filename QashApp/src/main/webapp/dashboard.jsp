...
List<String> idlist = shopCrud.listIds();
                ...
                <table class="table-minimalistic table-minimalistic-lined" style="width:950px" summary="Shop list">
                    ...
                    <tbody>
                        ...
                        for(String id : idlist) {
                            Shop shop = shopCrud.read(id);
                            dk.apaq.filter.Filter dateFilter = new CompareFilter<Date>("dateCreated", since30Days, CompareFilter.CompareType.GreaterOrEqual);
                            int itemCount = service.getItemCrud(shop).listIds().size();
                            int orderCount = service.getOrderCrud(shop).listIds(dateFilter, null).size();

                            out.println("<tr><td>");
                            out.println("<a icon=\"hyperlink\" href=\"/register/id:" + shop.getId() + "\">");
                            out.println(StringEscapeUtils.escapeHtml(shop.getName()));
                            out.println("</a></td>");
                            out.println("<td>" + shop.getServiceLevel());
                            ...
                            out.println("<td>" + StringEscapeUtils.escapeHtml(shop.getCreatedBy()) + "</td>");
                            out.println("</tr>");
                        }
                        %>

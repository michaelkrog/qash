...
public class AnnexServiceImpl implements AnnexService {
    ...
    public AnnexServiceImpl() {
        try {
            ...
            receiptTemplate = ve.getTemplate("/dk/apaq/qash/server/annex/templates/receipt_xhtml.vm");
            postingsTemplate = ve.getTemplate("/dk/apaq/qash/server/annex/templates/postings_csv.vm");
            invoiceTemplate = ve.getTemplate("/dk/apaq/qash/server/annex/templates/invoice_xhtml.vm", "utf-8");

    ...
    <body>
        ...
        <div id="in-benefits-container" >
            ...
            <table class="table-minimalistic">
                <tr>
                    <td class="lined"><spring:message code="account.username"/></td><td class="lined"><%=prepareText(account.getName())%></td>
                </tr>
                <tr>
                    <td><spring:message code="account.name"/></td><td><input type="text" name="name" value="<%=prepareText(name)%>" /></td>
                </tr>
                <tr>
                    <td><spring:message code="account.email"/></td><td><input type="text" name="email" value="<%=prepareText(email)%>" /></td>
                </tr>
                <tr>
                    <td><spring:message code="account.password"/></td><td><input type="password" name="password1" value="<%=prepareText(password)%>" /></td>
                </tr>
                <tr>
                    <td><spring:message code="account.confirmPassword"/></td><td><input type="password" name="password2" value="<%=prepareText(password)%>" /></td>
                </tr>

                <tr>
                    <td></td><td><input type="submit" class="button-standard" value="<spring:message code="account.save"/>" /></td>
                </tr>
            </table>
            </form>
            </p>

...
public abstract class AbstractCustomParser {
    ...
    private class CustomMarkupSettings implements IMarkupSettings {
	...
	private final IMarkupSettings markupSettings = new CustomMarkupSettings();
	 ...
	 */
	public AbstractCustomParser(final MarkupResourceStream resource)
	{
	 ...
	 *            The markup resource.
	 */
	public AbstractCustomParser(final String markup)
	{
	 ...
	 *            The markup resource (file)
	 */
	public AbstractCustomParser(final IXmlPullParser xmlParser, final MarkupResourceStream resource)
	{
